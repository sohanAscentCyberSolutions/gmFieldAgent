package com.example.md3.utils.animationClass;
...
public class AnimationUtil {
    ...
    public static Animation getRecyclerVireItemScrollAnimation(Context context, int position, int lastPosition){
        return AnimationUtils.loadAnimation(context,(position > lastPosition) ? R.anim.up_from_bottom: R.anim.down_from_top);
    }
