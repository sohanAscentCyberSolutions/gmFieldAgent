...
class VisitPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, VisitResult> {
        return try {
            ...
            val response = responseHandler.handleSuccess(api.requestForGetAllVisit(organisationID = organizationID, page = position , queryMap = queryMap))
