...
class CommissioningPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, NewCasesResult> {
        return try {
            ...
            val response = responseHandler.handleSuccess(api.requestForNewCases(organisationID = organizationID, assignedEngineer = assignedEngineer ,  page = position , type = "Commissioning" , queryMap = queryMap))
