...
import com.example.md3.data.model.visit.TotalJourneyHours
import com.google.gson.annotations.SerializedName

data class GetVisitDetailsResponse(
    ...
    @SerializedName("visit_commissioning_status")
    val visitCommissioningStatus: String,
    ...
    val totalJourneyHours: TotalJourneyHours,
